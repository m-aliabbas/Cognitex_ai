    ...
    <div className={cn("relative", className)}>
      ...
      >
        <img
          ...
          width={1920}
          height={1080}
          className="w-[100%] transition-all duration-200 group-hover:brightness-[0.8] ease-out rounded-md shadow-lg border"
        />
        ...
        {isVideoOpen && (
          ...
          >
            ...
            >
              ...
              <div className="size-full border-2 border-white rounded-[8px] overflow-hidden isolate z-[1] relative ">
                <iframe
                  src={videoSrc}
